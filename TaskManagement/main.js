...
const apiToPost = `https://656976ecde53105b0dd7128c.mockapi.io/api/users/${userId}/tasks/`;
...
listContainer.addEventListener("click", async function (e) {
    if (e.target.tagName === "LI") {
        ...
        async function changeCompletedStatus(target) {
            try {
                const response = await fetch(`https://656976ecde53105b0dd7128c.mockapi.io/api/users/${userId}/tasks/${target.id}`, {
                    method: 'GET',
                    headers: { 'Content-Type': 'application/json' }
                });
                ...
                const responsePut = await fetch(`https://656976ecde53105b0dd7128c.mockapi.io/api/users/${userId}/tasks/${target.id}`, {
                    method: 'PUT',
                    headers: { 'Content-Type': 'application/json' },
        ...
        fetch(`https://656976ecde53105b0dd7128c.mockapi.io/api/users/${userId}/tasks/${e.target.parentElement.id}`, {
            method: 'DELETE',
            headers: {'Content-Type': 'application/json'},
        })
            .then(response => response.json())
...
function displayTasks() {
    const userId = localStorage.getItem('userId');
    const apiUrl = `https://656976ecde53105b0dd7128c.mockapi.io/api/users/${userId}/tasks`;
